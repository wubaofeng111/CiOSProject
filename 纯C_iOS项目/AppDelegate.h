#ifndef __appdelegate__h__
#define __appdelegate__h__
...
public:
	AppDelegate();
	~AppDelegate();
	static BOOL AppDel_didFinishLaunching(AppDelegate *lApp, SEL _cmd, void *application, void *options);
	static void touchesBegin(void* touches ,void *event);
public:
...
//	id view = objc_msgSend((id)objc_msgSend((id)objc_getClass("View"), sel_getUid("alloc")), sel_getUid("initWithFrame:"), (struct CGRect) { 0, 0, 320, 480 });
//
